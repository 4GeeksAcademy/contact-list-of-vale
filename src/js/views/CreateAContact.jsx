    ...
    return (
        <div>
            <div className="container mx-auto py-3 px-3 ">
                <h1 className='fw-bold font-monospace'>Create a Contact</h1>

                <form onSubmit={handleSubmit}>
                    <div className="card p-4 max-w-5xl mx-auto max-h-screen">
                        <div className="mb-3">
                        ...
                        <button type="submit" className="btn btn-dark">Create Contact</button>
                    </div>
                </form>
            </div>
        </div>
